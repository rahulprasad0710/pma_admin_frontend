                ...
                <div className='grid grid-cols-1 lg:grid-cols-2 gap-8 rounded px-4 py-6'>
                    {features.map((feature, index) => (
                        <div
                            ...
                            className={`lg:hover:bg-white/5" relative z-10 flex cursor-pointer gap-x-4 whitespace-nowrap px-4 transition-all hover:bg-white/10 sm:mx-auto sm:px-0 lg:mx-0 lg:block lg:gap-x-0 lg:gap-y-1 lg:whitespace-normal ${
                                selectedFeature === index ? "bg-white/10" : ""
                            }`}
                            role='tablist'
